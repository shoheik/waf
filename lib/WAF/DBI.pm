...
sub select_one {
    my $self = shift;
    return $self->SUPER::select_one(WAF::DBI::_expand_args(@_));
}

sub select_row {
    my $self = shift;
    return $self->SUPER::select_row(WAF::DBI::_expand_args(@_));
}

sub select_all {
    my $self = shift;
    return $self->SUPER::select_all(WAF::DBI::_expand_args(@_));
}
...
sub query {
    my $self = shift;
    return $self->SUPER::query(WAF::DBI::_expand_args(@_));
}
